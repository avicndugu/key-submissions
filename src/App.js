...
const [searchTerm, setSearchTerm] = useState("grandmother");
    ...
    if(result.photos.length===0){
      return (
        <div className="App">
          ...
          <div className="container pt-1 pb-1">
            <div>
              <img src="https://via.placeholder.com/280x200.png?text=Pictures+not+found..." alt="placeholder" width="280" height="200"/>
            </div>
            <div>
              <img src="https://via.placeholder.com/280x200.png?text=Pictures+not+found..." alt="placeholder" width="280" height="200"/>
            </div>
